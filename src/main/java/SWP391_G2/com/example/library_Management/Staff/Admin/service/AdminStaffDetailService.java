...
import SWP391_G2.com.example.library_Management.Staff.Admin.repository.AdminStaffDetailRepository;
...
public class AdminStaffDetailService {
    @Autowired
    AdminStaffDetailRepository adminStaffDetailRepository;
    @Autowired
    ...
    public User findCustomerById(int id) {
        Optional<User> result = adminStaffDetailRepository.findById(Long.valueOf(id));
